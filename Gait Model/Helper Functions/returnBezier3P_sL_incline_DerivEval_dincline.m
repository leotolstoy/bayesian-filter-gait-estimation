function bezierDerivCoeffs3P = returnBezier3P_sL_incline_DerivEval_dincline(phase,stepLength,incline)
...
%  bezierDerivCoeffs3P = [(1).*stepLength.*(1-phase).^3,...
%      (1).*stepLength.*3*(1-phase).^2.*phase,...
%      (1).*stepLength.*3*(1-phase).*(phase).^2,...
%      (1).*stepLength.*(phase).^3,...
%      (1).*(1 - stepLength).*(1-phase).^3,...
%      (1).*(1 - stepLength).*3*(1-phase).^2.*phase,...
%      (1).*(1 - stepLength).*3*(1-phase).*(phase).^2,...
%      (1).*(1 - stepLength).*(phase).^3,...
%      (-1).*stepLength.*(1-phase).^3,...
%      (-1).*stepLength.*3*(1-phase).^2.*phase,...
%      (-1).*stepLength.*3*(1-phase).*(phase).^2,...
%      (-1).*stepLength.*(phase).^3,...
%      (-1).*(1 - stepLength).*(1-phase).^3,...
