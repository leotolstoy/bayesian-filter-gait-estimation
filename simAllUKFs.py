""" Simulates the phase estimator ukf using loaded data. """
import numpy as np
...
def main():
    ...
    data_filename_timing = f'{data_path}xsubject_timing_data_ukf.csv'
    ...
    for subjName in subjNames:
        ...
        for SIM_CONFIG in SIM_CONFIGS:
            ...
            plot_data,plot_data_measured, P_covars, state_std_devs,\
                ...
                phase_error_data, phase_dot_error_data, strideLength_error_data, incline_error_data = runGaussianFilter(data, phase_ukf,subj_biases,DO_MEASURE=True)
            ...
            filename = f'{data_path}{subjName}/{subjName}_UKFConfig_{SIM_CONFIG}_states.png'
